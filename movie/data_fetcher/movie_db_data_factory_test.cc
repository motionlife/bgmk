...
{
	std::string input = "{\"id\":284052,\"imdb_id\":\"tt1211837\",\"overview\":\"The movie's plot blah blah...\",\"title\":\"a movie\",\"runtime\":115}";
	...
	EXPECT_EQ(result->GetPlot(), "The movie's plot blah blah...");
